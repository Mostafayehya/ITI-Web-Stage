 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://webservice.lab1.day1/", wsdlLocation = "http://localhost:9191/calculator/ws/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://webservice.lab1.day1/", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9191/calculator/ws/calculator?wsdl");
    ...
    public Calculator getCalculatorImplPort() {
        return super.getPort(new QName("http://webservice.lab1.day1/", "CalculatorImplPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.lab1.day1/", "CalculatorImplPort"), Calculator.class, features);
    }
